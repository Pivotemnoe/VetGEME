(function (root, factory) {
  ...
  if (root) root.PET_CLINIC_P9_REVIEW_SURFACE_V2 = api;
  ...
  function createReviewSurface(options = {}) {
    ...
    function mount() {
      ...
      controls.dataset.p9ReviewSurface = "controls";
      ...
      heading.append(
        ...
        makeElement(document, "span", null, "Проверочная проекция из состояния симуляции")
      );
  ...
  return Object.freeze({ createReviewSurface });
});
