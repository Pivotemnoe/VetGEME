...
const p3Research = readJson("operational-production-authoring/generated/p3/research-catalog.json", repoRoot);
const p3Usages = readJson("operational-production-authoring/generated/p3/investigation-usage-policy.json", repoRoot);
const p6Economy = readJson("operational-production-authoring/generated/p6/economy-catalog.json", repoRoot);

const catalogs = [resourcesCatalog, visitsCatalog, capabilitiesCatalog, researchCatalog, usagesCatalog, scheduleCatalog, operationsPolicy];
