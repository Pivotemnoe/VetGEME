...
async function runHttpSmoke() {
  ...
  const deniedPaths = [
    ...
    "/content/review-inputs/vetgeme-p9-visual-state-authoring-2026.07.16.2/provenance.json",
    "/content/review-inputs/vetgeme-p9-visual-state-authoring-2026.07.16.2/source/MANIFEST.json",
